...
// router.get("/productListByCategoryAndTagsArMain"  , async (req , res)=>{
...
//     var docCountTemp4 = ''; 
//     if(req.query.state === 'category'){
//         docCountTemp4 = await productAr.countDocuments({categories:req.query.id , deleteDate:null}).exec()/limit
//     }else if(req.query.state === 'tag'){
//         docCountTemp4 = await productAr.countDocuments({tags:req.query.id , deleteDate:null}).exec()/limit
//     }

//     if(isNum(docCountTemp)){
//         totalPages=docCountTemp4;
//     }else{
//         totalPages = Math.floor(docCountTemp4)+1;
//     }

//     var docCountTemp3 = ''; 
//     if(req.query.state === 'category'){
//         docCountTemp3 = await productAr.countDocuments({categories:req.query.id ,deleteDate:null}).exec();
//     }else if(req.query.state === 'tag'){
//         docCountTemp3 = await productAr.countDocuments({tags:req.query.id ,deleteDate:null}).exec();
//     }
//    if(endIndex <  docCountTemp3){
//     results.next = {
//       total: totalPages  ,
//         page : page + 1,
//         limit: limit
